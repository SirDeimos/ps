...
Basic HTML Structure	Help Help | Top Top
<html>
 <head>
...
Text Formatting	Help Help | Top Top
...
href=mailto:email	Link which initiates an email (dependant on users email client).
